            ...
            <Card key={pr.id} style={{ padding: '14px 18px', opacity: merged ? 0.65 : 1 }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 13, fontWeight: 500, color: T.tx1, marginBottom: 4 }}>{pr.title}</div>
                  <div style={{ fontSize: 12, color: T.tx3, marginBottom: 8 }}>{pr.desc}</div>
